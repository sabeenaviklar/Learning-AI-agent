      ...
      <div style={styles.cardWrapper}>
        ...
        <div style={styles.visualPane}>
          ...
          <div style={styles.visualContent}>
            ...
            <h2 style={styles.visualTitle}>Create Your AI Learner Profile</h2>
            <p style={styles.visualSub}>
              Establish a personalized profile to structure roadmap paths, evaluate your current coding knowledge, and deploy dynamic micro-revisions.
            </p>
        ...
        <div style={styles.formPane}>
          <div style={styles.formHeader}>
            <h3 style={styles.formTitle}>Get Started</h3>
            <p style={styles.formSub}>Create a free account and start learning smarter.</p>
          </div>
          ...
          <div style={styles.oauthRow}>
            <button onClick={() => handleOAuthSignup('google')} style={styles.oauthBtn}>
              <Chrome size={18} color="#EA4335" />
              <span>Google</span>
            </button>
            <button onClick={() => handleOAuthSignup('github')} style={styles.oauthBtn}>
              <Github size={18} color="#18181B" />
              <span>GitHub</span>
            </button>
          </div>
...
const styles = {
  ...
  visualPane: {
    flex: 1,
    background: 'linear-gradient(135deg, #18181B 0%, #1E3A8A 50%, #3B82F6 100%)',
    padding: '3rem',
